...
public class SelfServerHostedOpenGLRtmpActivity extends AppCompatActivity
    ...
    public void onConnectionSuccessRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SelfServerHostedOpenGLRtmpActivity.this, "Connection success", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onConnectionFailedRtmp(final String reason) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SelfServerHostedOpenGLRtmpActivity.this, "Connection failed. " + reason, Toast.LENGTH_SHORT)
                        .show();
    ...
    public void onDisconnectRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SelfServerHostedOpenGLRtmpActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onAuthErrorRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SelfServerHostedOpenGLRtmpActivity.this, "Auth error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onAuthSuccessRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(SelfServerHostedOpenGLRtmpActivity.this, "Auth success", Toast.LENGTH_SHORT).show();
            }
        });
    }
